...
public class RenderOpaqueLiftDoor extends BlockEntityRendererMapper<OpaqueLiftDoorBlock.OpaqueLiftDoorTileEntity> implements IGui, IBlock {
    ...
    @Override
    public void render(OpaqueLiftDoorBlock.OpaqueLiftDoorTileEntity entity, float tickDelta, PoseStack matrices,
    ...
    @Override
    public boolean shouldRenderOffScreen(OpaqueLiftDoorBlock.OpaqueLiftDoorTileEntity blockEntity) {
        return true;
    }
