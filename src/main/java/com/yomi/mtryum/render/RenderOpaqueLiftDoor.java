...
public class RenderOpaqueLiftDoor extends BlockEntityRendererMapper<BlockPSDAPGDoorBase.TileEntityPSDAPGDoorBase> implements IGui, IBlock {
    ...
    // 门板模型：左侧 [0,12]，右侧 [4,16]，28 像素宽 UV 布局
    ...
    @Override
    public void render(BlockPSDAPGDoorBase.TileEntityPSDAPGDoorBase entity, float tickDelta, PoseStack matrices,
